    document.addEventListener('DOMContentLoaded', function() {
        ...
        function calculateNumberOfNights() {
            ...
            //const precioTotal = document.getElementById('preciototal');
            //const precioNocheString = document.getElementById('precioNoche').getAttribute('data-precio-noche');
            //const precioNocheNumber = parseInt(precioNocheString); // Convert string to integer
